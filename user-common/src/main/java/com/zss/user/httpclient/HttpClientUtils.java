package com.zss.user.httpclient;
...
import com.zss.user.util.StringUtil;
...
public class HttpClientUtils {
    ...
    public static String doGet(String url) throws IOException, URISyntaxException {
        CloseableHttpClient httpClient = createHttpClient(DEFAULT_SOCKET_TIMEOUT); //  默认超时时间（5000毫秒）
    ...
    public static JSONObject postJson(String url, Object paramsObj) throws IOException {
        CloseableHttpClient httpClient = createHttpClient(DEFAULT_SOCKET_TIMEOUT); // 默认超时时间（5000毫秒）
        String bean2json = StringUtil.bean2json(paramsObj);
        logger.info(bean2json);
		return JSONObject.parseObject(executePost(httpClient, url, bean2json, null, null, null, true));
    }
     ...
     * @throws IOException
     */
    public static JSONObject postJsonSwallowException(String url, Object paramsObj) {
        try{
	    	CloseableHttpClient httpClient = createHttpClient(DEFAULT_SOCKET_TIMEOUT); // 默认超时时间（5000毫秒）
	        return JSONObject.parseObject(executePost(httpClient, url, StringUtil.bean2json(paramsObj), null, null, null, true));
        }catch(Exception e){
